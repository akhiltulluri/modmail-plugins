...
class Fun(Cog):
    ...
    async def roast(self, ctx,*, user: discord.Member = None):
        ...
        roasts = ["I'd give you a nasty look but you've already got one.", "Your brain is as thicc as a Game Boy. And not the good kind of thicc.", "yub in the tub", "It's a bird, it's a plane!!! Oh. It's you. :/", "Imagine trying to switch Gangs. Oh wait, it doesn't matter. YOU GET CARRIED ANYWAY", "Someday you'll go far... and I hope you stay there.", "You main Joker. Not a roast, but you're carried.", "I hope you go broke in ReefRaid. Oh wait, you don't even play it. Sad.", "Oh, I'm sorry, you mispelled what you said. I thought you were Yub.", "I hope you run out of toilet paper. :sunglasses:", "Brains aren't everything. In your case, they're nothing.", "I may not be perfect, but at least I'm not on Planet Popstar.", "I may not be perfect, but at least I'm not on Hyrule Warriors.", "I may not be perfect, but at least I'm not on Mushroom Kingdom.", "You're so bad at Smash that when you spam your B button, its the snack that smiles back.", "Quick - check your face! I just found your nose in my business.", "It's better to let someone think you're stupid than open your mouth and prove it.", "imagine having a pocket joker, couldn't be me", "I'd slap you but I don't want to make your face look any better.", "You have the right to remain silent because whatever you say will probably be stupid anyway."]
